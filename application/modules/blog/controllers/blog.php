...
class Blog extends MX_Controller
{
    ...
    function create() {
        ...
        if($submit=="Submit") {
            ...
            if($this->form_validation->run() == TRUE) {
                ...
                //convert the datepicker into a unix timestipe
                $data['date_published'] = $this->timedate->make_timestamp_from_datepicker_us($data['date_published']);

                if(is_numeric($update_id)) {
                    //update the page details
                    $this->_update($update_id, $data);
                    $flash_msg = "The blog entry details were successfully update.";
    ...
    /*function test() {
        $this->load->module('timedate');
        $nowtime = time();
        $datepicker_time_ina = $this->timedate->get_nice_date($nowtime, 'datepicker_ina');
        echo $datepicker_time_ina;
        echo "<hr>";
        //convert back into unix timestamp
        $timestamp = $this->timedate->make_timestamp_from_datepicker_us("10/23/2016");
        echo $timestamp;
        echo "<hr>";
        $datepicker_time_indo = $this->timedate->get_nice_date($timestamp, 'indodesia');
        echo $datepicker_time_indo;        
    }*/
