...
class Store_categories extends MX_Controller
{
    ...
    function create() {
        ...
        if($submit=="Submit") {
            ...
            if($this->form_validation->run() == TRUE) {
                ...
                if(is_numeric($update_id)) {
                    ...
                    $flash_msg = "The category details were successfully update.";
        ...
        $data['option'] = $this->_get_dropdown_options($update_id);
        $data['num_dropdown_options'] = count($data['option']);
