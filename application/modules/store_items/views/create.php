...
<div class="row-fluid sortable">
	<div class="box span12">
		...
		<div class="box-content">
			<?php
			if($big_pic=="") { ?>
				<a href="<?= base_url()?>store_items/upload_image/<?= $update_id ?>"><button type="button" class="btn btn-primary">Upload Image Item</button></a>
			<?php
			} else {
			?>
				<a href="<?= base_url()?>store_items/delete_image/<?= $update_id ?>"><button type="button" class="btn btn-danger">Delete Image Item</button></a>
			<?php
			}
			?>
					...
					<div class="control-group">
						...
						<div class="controls">
							<?php
								...
								echo form_dropdown('status', $option, $status, $additional_dd_code);
							?>
						</div>
					</div>
